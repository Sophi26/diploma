module.exports = () => {
    ...
    let db = new Datastore({ filename : 'exp_data'} );
    db.loadDatabase();
    let db_fig = new Datastore({ filename : 'figure_sequence'} );
    db_fig.loadDatabase();
    ...
    app.post(
        ...
        (req, res) => {
            ...
            db.findOne({}).sort({ test_id: -1 }).exec((err, doc) => {
    ...
    app.post(
        ...
        (req, res) => {
            ...
            const fig_data = { figure: fig_name };
            
            db_fig.remove(fig_data, {});
    ...
    app.post(
        ...
        (req, res) => {
            ...
            db_fig.insert(fig_data, (err, result) => {});
    ...
    app.post(
        ...
        (req, res) => {
            ...
            const fig_data = { hypothesis: hyp_name };
