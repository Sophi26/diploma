...
function main(store) {
    ...
    const side_recent = document.getElementById("side-recent");
    const side_all = document.getElementById("side-all");
    const sidebar = document.querySelectorAll("#selection-categories li");

    side_recent.addEventListener('click', () => {
        while(expFlexContainer.children.length > 1) {
            expFlexContainer.removeChild(expFlexContainer.firstChild);
        }

        sidebar[1].classList.remove("active-category");
        sidebar[0].classList.add("active-category");
    ...
    side_all.addEventListener('click', () => {
        while(expFlexContainer.children.length > 1) {
            expFlexContainer.removeChild(expFlexContainer.firstChild);
        }

        sidebar[1].classList.add("active-category");
        sidebar[0].classList.remove("active-category");
